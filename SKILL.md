...
### 4. Advanced Workflows & Examples

If you want to see how to use AIF Engine to build complex systems (like an autonomous crypto trading bot) or how to handle dynamic JWT authentication, please refer to the `references/` and `assets/` directories:

*   **View Use Cases:** `references/use-cases.md`
*   **Template Files:** See the `assets/` folder for `.json` and `.py` examples.
